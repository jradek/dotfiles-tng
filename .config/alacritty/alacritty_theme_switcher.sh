# source:
#   https://github.com/thapakazi/kutto_kodalo/blob/gumantae/shellrc.d/alacrity.sh
...
list_themes(){
    if check_if_themes_exists; then
        ...
        echo "-----------------------------"
        ls -1 $alacritty_themes_dir/*.yaml|sed -E 's/(.*)\/(.*).yaml/    \2/g'
    else
